...
/**
 * Melipayamak Classic REST Client (Username/Password)
 *
 * Handles REST API communication with Melipayamak using username/password authentication.
...
class ClassicClient
{
    ...
    public function __construct(string $username, string $password, string $baseUrl, int $timeout = 10)
    {
